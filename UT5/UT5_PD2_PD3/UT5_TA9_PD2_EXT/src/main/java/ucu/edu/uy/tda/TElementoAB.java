...
// tiene los dos hijos, buscamos el lexicograficamente anterior
    ...
    public int cantNodosNivel(int nivel) {
        ...
        if (this.hijoIzq != null){
            cantNodosNivelIzq = this.hijoIzq.cantNodosNivel(nivel-1);
        }
        if (this.hijoDer != null){
            cantNodosNivelDer = this.getHijoDer().cantNodosNivel(nivel-1);
        }
    ...
    public int NodosNivel(int nivel) {
        ...
        else if (this.getHijoIzq() == null && this.getHijoDer() == null && nivel > 0 ){
            return 0;
        }
        else if (this.getHijoIzq() == null && this.getHijoDer() != null ){
            return 0 + this.getHijoDer().NodosNivel (nivel-1);
        }
        else if (this.getHijoDer() == null && this.getHijoIzq() != null){
            return 0 + this.getHijoIzq().NodosNivel (nivel-1);
        }
        else{
            return this.getHijoIzq().NodosNivel (nivel-1) + this.getHijoIzq().NodosNivel(nivel-1);
        }
